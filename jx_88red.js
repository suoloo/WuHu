...
export jx88HelpPins="11111111111,22222222222,3333333333" ##cookie pin值,多个用逗号隔开
温馨提示：如提示助力火爆，可尝试寻找京东客服
脚本兼容: Quantumult X, Surge, Loon, JSBox, Node.js
url:https://raw.githubusercontent.com/suoloo/Selfish/main/jx_88red.js
==============Quantumult X==============
[task_local]
#京喜领88元红包
0 0 * * * jd_jxlhb.js, tag=京喜领88元红包, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

==============Loon==============
[Script]
cron "0 0 * * *" script-path=jd_jxlhb.js,tag=京喜领88元红包

================Surge===============
京喜领88元红包 = type=cron,cronexp="0 0 * * *",wake-system=1,timeout=3600,script-path=jd_jxlhb.js

===============小火箭==========
京喜领88元红包 = type=cron,script-path=jd_jxlhb.js, cronexpr="0 0 * * *", timeout=3600, enable=true
 */
const $ = new Env('京喜领88元红包');
const notify = $.isNode() ? require('./sendNotify') : {};
const jdCookieNode = $.isNode() ? require('./jdCookie.js') : {};
let pins = process.env.jx88HelpPins ?? ""
...
!(async () => {
  ...
  if(!pins){
    console.log("请设置环境变量jx88HelpPins")
  }
